...
꾸준한 자기 개발과 배움에 열정을 가진 프론트엔드 개발자입니다. 
풀스택 개발자로 성장하기 위해 현재 익힌 기술들을 꾸준히 발전시키고, 새로운 기술에도 도전하며 역량을 넓혀가고자 합니다. 
사용자가 쉽게 접근할 수 있는 직관적인 서비스를 제공하기 위해 항상 사용자 관점을 고려하고, 팀원들과 긴밀히 협력하여 최상의 결과를 이루는 개발자가 되겠습니다.
